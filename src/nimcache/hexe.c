...
/* Command for C compiler:
   gcc -c  -w  -I/usr/lib/nim -o /home/cgp/Develop/hexe/src/nimcache/hexe.o /home/cgp/Develop/hexe/src/nimcache/hexe.c */
...
#include <string.h>
#undef linux
typedef struct Appobj_aKR7UOPHX9aOsjvu3dmJqkw Appobj_aKR7UOPHX9aOsjvu3dmJqkw;
...
struct  Appobj_aKR7UOPHX9aOsjvu3dmJqkw  {
void* window;
void* renderer;
};
...
N_NIMCALL(NIM_BOOL, init_9byZ44PbEKHjyo8KVcz6ygw)(Appobj_aKR7UOPHX9aOsjvu3dmJqkw* app0);
N_NIMCALL(NimStringDesc*, cstrToNimstr)(NCSTRING str0);
static N_INLINE(void, nimFrame)(TFrame* s0);
N_NOINLINE(void, stackoverflow_II46IjNZztN9bmbxUD8dt8g)(void);
static N_INLINE(void, popFrame)(void);
N_NIMCALL(NIM_BOOL, events_FvTTz09cMbwZsUzeZR8eu9cA)(void);
N_NIMCALL(NimStringDesc*, reprEnum)(NI e0, TNimType* typ0);
N_NIMCALL(void, exit_6XnR8FxKS7cBkCQckBtVEg)(Appobj_aKR7UOPHX9aOsjvu3dmJqkw* app0);
static N_NIMCALL(void, Marker_TY_E1ajJyjcfyr8TKPky9bIFQg)(void* p, NI op);
N_NIMCALL(void, nimGCvisit)(void* d0, NI op0);
static N_NIMCALL(void, T_0S6KyOcuUfjaX47VajhoZg_9)(void);
...
NIM_EXTERNC N_NOINLINE(void, hexeDatInit000)(void);
...
Appobj_aKR7UOPHX9aOsjvu3dmJqkw* app_jL4QFGXUPSpq6haJxStXCA;
TNimType NTI_aKR7UOPHX9aOsjvu3dmJqkw;
extern TNimType NTI_vr5DoT1jILTGdRlYv1OYpw;
TNimType NTI_E1ajJyjcfyr8TKPky9bIFQg;
extern Gcheap_1TRH1TZMaVZTnLNcIHuNFQ gch_IcYaEuuWivYAS86vFMTS3Q;
NIM_BOOL done_r4eKLn7L7AakTe2LPWCx6A;
extern TY_fbYpjfe38x3ujjAmVRbI1Q Dl_109970;
extern TY_32w2ZypAyMWuajvi2Jt79cg Dl_110047;
STRING_LITERAL(T_0S6KyOcuUfjaX47VajhoZg_2, "ERROR: Can\'t initialize SDL: ", 29);
STRING_LITERAL(T_0S6KyOcuUfjaX47VajhoZg_3, "ERROR: Can\'t create window: ", 28);
STRING_LITERAL(T_0S6KyOcuUfjaX47VajhoZg_4, "ERROR: Can\'t create renderer: ", 30);
STRING_LITERAL(T_0S6KyOcuUfjaX47VajhoZg_5, "ERROR: Can\'t set draw color: ", 29);
STRING_LITERAL(T_0S6KyOcuUfjaX47VajhoZg_6, "SDL initialized successfully", 28);
STRING_LITERAL(T_0S6KyOcuUfjaX47VajhoZg_7, "SDL shutdown completed", 22);
STRING_LITERAL(T_0S6KyOcuUfjaX47VajhoZg_10, "Warning: Can\'t clear screen: ", 29);
...
{	result0 = (NIM_BOOL)0;
	nimln(22, "hexe.nim");
	{
		...
		printf("%s%s\012", ((NimStringDesc*) &T_0S6KyOcuUfjaX47VajhoZg_2)? (((NimStringDesc*) &T_0S6KyOcuUfjaX47VajhoZg_2))->data:"nil", LOC7? (LOC7)->data:"nil");
		fflush(stdout);
		nimln(24, "hexe.nim");
		result0 = NIM_FALSE;
		goto BeforeRet;
	...
	LA4: ;
	nimln(26, "hexe.nim");
	(*app0).window = Dl_105912("Hexe", ((int) 536805376), ((int) 536805376), ((int) 800), ((int) 600), ((NU32) 32));
	nimln(33, "hexe.nim");
	{
		NCSTRING LOC12;
		NimStringDesc* LOC13;
		...
		printf("%s%s\012", ((NimStringDesc*) &T_0S6KyOcuUfjaX47VajhoZg_3)? (((NimStringDesc*) &T_0S6KyOcuUfjaX47VajhoZg_3))->data:"nil", LOC13? (LOC13)->data:"nil");
		fflush(stdout);
		nimln(35, "hexe.nim");
		result0 = NIM_FALSE;
		goto BeforeRet;
	...
	nimln(39, "hexe.nim");
	{
		...
		printf("%s%s\012", ((NimStringDesc*) &T_0S6KyOcuUfjaX47VajhoZg_4)? (((NimStringDesc*) &T_0S6KyOcuUfjaX47VajhoZg_4))->data:"nil", LOC19? (LOC19)->data:"nil");
		fflush(stdout);
		nimln(41, "hexe.nim");
		result0 = NIM_FALSE;
		goto BeforeRet;
	...
	nimln(44, "hexe.nim");
	{
		...
		printf("%s%s\012", ((NimStringDesc*) &T_0S6KyOcuUfjaX47VajhoZg_5)? (((NimStringDesc*) &T_0S6KyOcuUfjaX47VajhoZg_5))->data:"nil", LOC26? (LOC26)->data:"nil");
		fflush(stdout);
		nimln(46, "hexe.nim");
		result0 = NIM_FALSE;
		goto BeforeRet;
	...
	LA23: ;
	nimln(48, "hexe.nim");
	printf("%s\012", ((NimStringDesc*) &T_0S6KyOcuUfjaX47VajhoZg_6)? (((NimStringDesc*) &T_0S6KyOcuUfjaX47VajhoZg_6))->data:"nil");
	fflush(stdout);
	nimln(49, "hexe.nim");
	result0 = NIM_TRUE;
	goto BeforeRet;
...
N_NIMCALL(void, exit_6XnR8FxKS7cBkCQckBtVEg)(Appobj_aKR7UOPHX9aOsjvu3dmJqkw* app0) {
	...
	Dl_100837();
	nimln(75, "hexe.nim");
	printf("%s\012", ((NimStringDesc*) &T_0S6KyOcuUfjaX47VajhoZg_7)? (((NimStringDesc*) &T_0S6KyOcuUfjaX47VajhoZg_7))->data:"nil");
	fflush(stdout);
	popFrame();
}
static N_NIMCALL(void, Marker_TY_E1ajJyjcfyr8TKPky9bIFQg)(void* p, NI op) {
	Appobj_aKR7UOPHX9aOsjvu3dmJqkw* a;
	a = (Appobj_aKR7UOPHX9aOsjvu3dmJqkw*)p;
}
static N_NIMCALL(void, T_0S6KyOcuUfjaX47VajhoZg_9)(void) {
	nimGCvisit((void*)app_jL4QFGXUPSpq6haJxStXCA, 0);
}
...
NIM_EXTERNC N_NOINLINE(void, NimMainModule)(void) {
	Appobj_aKR7UOPHX9aOsjvu3dmJqkw* LOC1;
	nimfr("hexe", "hexe.nim")
nimRegisterGlobalMarker(T_0S6KyOcuUfjaX47VajhoZg_9);
	nimln(83, "hexe.nim");
	LOC1 = (Appobj_aKR7UOPHX9aOsjvu3dmJqkw*)0;
	LOC1 = (Appobj_aKR7UOPHX9aOsjvu3dmJqkw*) newObj((&NTI_E1ajJyjcfyr8TKPky9bIFQg), sizeof(Appobj_aKR7UOPHX9aOsjvu3dmJqkw));
	(*LOC1).window = NIM_NIL;
	(*LOC1).renderer = NIM_NIL;
	asgnRefNoCycle((void**) (&app_jL4QFGXUPSpq6haJxStXCA), LOC1);
	nimln(84, "hexe.nim");
	done_r4eKLn7L7AakTe2LPWCx6A = NIM_FALSE;
	nimln(86, "hexe.nim");
	{
		NIM_BOOL LOC4;
		LOC4 = (NIM_BOOL)0;
		LOC4 = init_9byZ44PbEKHjyo8KVcz6ygw(app_jL4QFGXUPSpq6haJxStXCA);
		if (!LOC4) goto LA5;
		{
			nimln(88, "hexe.nim");
			while (1) {
				if (!!(done_r4eKLn7L7AakTe2LPWCx6A)) goto LA8;
				nimln(90, "hexe.nim");
				{
					int LOC11;
					NCSTRING LOC14;
					...
					nimln(90, "hexe.nim");
					LOC11 = (int)0;
					LOC11 = Dl_109970((*app_jL4QFGXUPSpq6haJxStXCA).renderer);
					...
					printf("%s%s\012", ((NimStringDesc*) &T_0S6KyOcuUfjaX47VajhoZg_10)? (((NimStringDesc*) &T_0S6KyOcuUfjaX47VajhoZg_10))->data:"nil", LOC15? (LOC15)->data:"nil");
					fflush(stdout);
				}
				LA12: ;
				nimln(94, "hexe.nim");
				Dl_110047((*app_jL4QFGXUPSpq6haJxStXCA).renderer);
				nimln(96, "hexe.nim");
				done_r4eKLn7L7AakTe2LPWCx6A = events_FvTTz09cMbwZsUzeZR8eu9cA();
			} LA8: ;
		}
	}
	LA5: ;
	nimln(99, "hexe.nim");
	exit_6XnR8FxKS7cBkCQckBtVEg(app_jL4QFGXUPSpq6haJxStXCA);
	popFrame();
}

NIM_EXTERNC N_NOINLINE(void, hexeDatInit000)(void) {
static TNimNode* T_0S6KyOcuUfjaX47VajhoZg_8[2];
static TNimNode T_0S6KyOcuUfjaX47VajhoZg_0[3];
NTI_aKR7UOPHX9aOsjvu3dmJqkw.size = sizeof(Appobj_aKR7UOPHX9aOsjvu3dmJqkw);
NTI_aKR7UOPHX9aOsjvu3dmJqkw.kind = 18;
NTI_aKR7UOPHX9aOsjvu3dmJqkw.base = 0;
NTI_aKR7UOPHX9aOsjvu3dmJqkw.flags = 3;
T_0S6KyOcuUfjaX47VajhoZg_8[0] = &T_0S6KyOcuUfjaX47VajhoZg_0[1];
T_0S6KyOcuUfjaX47VajhoZg_0[1].kind = 1;
T_0S6KyOcuUfjaX47VajhoZg_0[1].offset = offsetof(Appobj_aKR7UOPHX9aOsjvu3dmJqkw, window);
T_0S6KyOcuUfjaX47VajhoZg_0[1].typ = (&NTI_vr5DoT1jILTGdRlYv1OYpw);
T_0S6KyOcuUfjaX47VajhoZg_0[1].name = "window";
T_0S6KyOcuUfjaX47VajhoZg_8[1] = &T_0S6KyOcuUfjaX47VajhoZg_0[2];
T_0S6KyOcuUfjaX47VajhoZg_0[2].kind = 1;
T_0S6KyOcuUfjaX47VajhoZg_0[2].offset = offsetof(Appobj_aKR7UOPHX9aOsjvu3dmJqkw, renderer);
T_0S6KyOcuUfjaX47VajhoZg_0[2].typ = (&NTI_vr5DoT1jILTGdRlYv1OYpw);
T_0S6KyOcuUfjaX47VajhoZg_0[2].name = "renderer";
T_0S6KyOcuUfjaX47VajhoZg_0[0].len = 2; T_0S6KyOcuUfjaX47VajhoZg_0[0].kind = 2; T_0S6KyOcuUfjaX47VajhoZg_0[0].sons = &T_0S6KyOcuUfjaX47VajhoZg_8[0];
NTI_aKR7UOPHX9aOsjvu3dmJqkw.node = &T_0S6KyOcuUfjaX47VajhoZg_0[0];
NTI_E1ajJyjcfyr8TKPky9bIFQg.size = sizeof(Appobj_aKR7UOPHX9aOsjvu3dmJqkw*);
NTI_E1ajJyjcfyr8TKPky9bIFQg.kind = 22;
NTI_E1ajJyjcfyr8TKPky9bIFQg.base = (&NTI_aKR7UOPHX9aOsjvu3dmJqkw);
NTI_E1ajJyjcfyr8TKPky9bIFQg.flags = 2;
NTI_E1ajJyjcfyr8TKPky9bIFQg.marker = Marker_TY_E1ajJyjcfyr8TKPky9bIFQg;
}
